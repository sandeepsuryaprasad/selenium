...
class RelativeBy:
    ...
    def __init__(self, root: Optional[Dict[Union[By, str], str]] = None, filters: Optional[List] = None) -> None:
        """
    ...
    def above(self, element_or_locator: Union[WebElement, Dict] = None) -> Self:
        """
    ...
    def below(self, element_or_locator: Union[WebElement, Dict] = None) -> Self:
        """
    ...
    def to_left_of(self, element_or_locator: Union[WebElement, Dict] = None) -> Self:
        """
    ...
    def to_right_of(self, element_or_locator: Union[WebElement, Dict] = None) -> Self:
        """
    ...
    def near(self, element_or_locator_distance: Union[WebElement, Dict, int] = None) -> Self:
        """
